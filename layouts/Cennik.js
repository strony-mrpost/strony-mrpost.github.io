...
<div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
    ...
    {plans.map((plan, index) => (
        <div key={plan.title + index} class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-200 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">{plan.subtitle}Best option for personal use & for your next project.</p>
        ...
        <Link href="#" class="text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:ring-purple-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-purple-900">Rozpocznij</Link>
