...
<section class="bg-gray-50 dark:bg-gray-800">
    <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
        ...
        <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16 mt-24">
            <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Wsparcie w obszarze social mediów i reklamy</h2>
        ...
        <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
          ...
          alt="feature image 2"/>
            ...
            <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Zadbaj o swoje media społecznościowe i reklamę</h2>
  ...
  <div class="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
    <div class="col-span-2 mb-8">
      ...
      <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Nasze rygorystyczne standardy bezpieczeństwa i zgodności są sercem naszej działalności. Pracujemy nieustannie, aby chronić Ciebie i Twoich klientów.</p>
